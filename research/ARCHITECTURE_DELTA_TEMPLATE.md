...
Usage:
- Save one file per architecture-affecting branch under `research/architecture_deltas/`.
- If no architecture-affecting work occurred, do not create a delta file; state `no architecture state change` in closeout instead.
